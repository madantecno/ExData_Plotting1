...
png("./Coursera asgmnt/expl analys project files//Week one project files/plot4.png",width=480,height=480)
par(mfrow=c(2,2))
...
plot(dataset$Global_reactive_power,type="l",xaxt='n',ylab="Voltage",xlab="datetime")
axis(1,at=c(1,4000000,8000000),labels=c("Thu", "Fri","sat"))
dev.off()